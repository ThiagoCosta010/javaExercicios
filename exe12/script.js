...
let lon1 = document.querySelector('#lon2')
...
function jogada(){
    ...
    let longJogada = longitudeJogada+direcaoLongitudeJogada
    ...
    for(let v = 0; v <= 4; v++){
        if(latJogada == ships[v].lat && longJogada == ships[v].long){
    ...
    for(let l = 0; l <= 9; l++){
        if(latJogada == ships[l].lat && longJogada == ships[l].long){
